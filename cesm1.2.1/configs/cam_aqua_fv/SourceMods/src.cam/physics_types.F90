...
!===============================================================================
  subroutine physics_dme_adjust(state, tend, qini, dt)
    ...
    do k = 1, pver
       ...
       ! adjusment factor is change in water vapor, allowing for large values of q
       ! maximum set at 10 for numerical reasons, extremely unlikely would ever get near this in a single timestep
       fdq(:ncol) = min(10._r8, (1._r8  - qini(:ncol,k))/(1._r8 - state%q(:ncol,k,1)))
