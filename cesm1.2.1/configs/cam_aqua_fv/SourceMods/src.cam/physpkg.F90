...
subroutine phys_init( phys_state, phys_tend, pbuf2d, cam_out )
    ...
    use physconst,          only: rair, cpair, cpwv, gravit, stebol, tmelt, &
                                  ...
                                  karman, rhodair, physconst_init, physconst_exo_print
    ...
    use exo_radiation_cam_intr, only: exo_radiation_init
    ...
    ! print share constants as updated by exoplanet_mod
    call physconst_exo_print
...
subroutine tphysbc (ztodt,               &
    ...
    use exo_radiation_cam_intr, only: exo_radiation_tend
...
!!  use radiation,           only: radiation_do !! REMOVE
